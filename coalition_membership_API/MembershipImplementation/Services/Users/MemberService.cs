    ...
    public class MemberService : IMemberService
    {
        ...
        public async Task<ResponseMessage> MakePaymentConfirmation(string txt_rn)
        {
            ...
            if (member != null && memberType != null && (member.MemberId == null || member.MemberId == ""))
            {
                ...
                var message = $"Congratulation {member.FullName}, being ABI-ZEER Member!!!\n" +
                    $"We have received your payment and would like to thank you for \n being a member of ABI-ZEER Association. \n" +
                    $"Your Membership ID is {member.MemberId} you can login through https://abizeermembership.com using the provided membership Id.";
            ...
            if (currentPayment != null)
            {
                ...
                if (currentPayment.PaymentStatus != PaymentStatus.PAID && !currentPayment.IsPaid)
                {
                    ...
                    if (payments)
                    {
                        ...
                        {
                            var message = $"Congratulation {member.FullName} , your ABI-ZEER Membership has been successfully renewed!\n" +
                                          ...
                                          $"Your renewed Membership ID is {member.MemberId}, valid until {currentPayment.ExpiredDate.ToString("MMMM dd, yyyy")}. You can log in through https://abizeermembership.com using your Membership ID.";
...
private async Task CreateAndNotifyUser(Member member, string memberID)
{
    ...
    var message = $"Congratulations {member.FullName} on becoming an ABI-ZEER Member! \n" +
                  $"We have received your payment, thank you for being a part of the ABI-ZEER  Association. \n" +
                  $"Your Membership ID is {memberID}. You can log in at https://abizeermembership.com with this ID.";
    ...
    .ToListAsync();
            ...
            foreach (var payment in memberPayments)
            {
                ...
                var message = $"Dear ABI-ZEER Member {payment.Member.FullName},\n\n" +
                  ...
                  $"Please renew your membership by visiting https://abizeermembership.com and using your Membership ID: {payment.Member.MemberId}.";
            ...
            foreach (var payment in memberPayments10days)
            {
                ...
                var message = $"Membership Expiration Warning!!!\n" +
                    ...
                    $"Your Membership ID is {payment.Member.MemberId} you can login through https://abizeermembership.com and extend your membership .";
                var email = new EmailMetadata
